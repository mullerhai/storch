...
class Conv2dSuite1 extends munit.FunSuite {
  test("Conv2dSuite1 output shapes") {
    val m12 = nn.Conv2d(in_channels = 16, out_channels = 33, kernel_size = (3, 5), stride = (2, 1), padding = (4, 2), dilation = (3, 1))
    val input1 = torch.randn(Seq(20, 16, 50, 100))
    val output = m12(input1)
    //    val input2 = torch.randn(Seq(16, 5, 7, 7, 7, 7))
    assertEquals(output.shape, Seq(20, 33, 26, 100)) //torch.Size([100])  failed Actual   :ArraySeq(20, 33, 22, 96)
    //    println(m12(input))
  }
}
...
class Conv2dSuite extends munit.FunSuite {
  test("Conv2dSuite output shapes") {
    val m12 = nn.Conv2d(in_channels = 16, out_channels = 33, kernel_size = (3, 5), stride = (2, 1), dilation = (3, 1))
    val input1 = torch.randn(Seq(20, 16, 50, 100))
    val output = m12(input1)
    //    val input2 = torch.randn(Seq(16, 5, 7, 7, 7, 7))
    assertEquals(output.shape, Seq(20, 33, 22, 96)) //torch.Size([100])  failed Actual   :ArraySeq(20, 33, 22, 96)
    //    println(m12(input))
  }
}
...
class Conv3dSuite extends munit.FunSuite {
  test("Conv3dSuite output shapes") {
    val m12 = nn.Conv3d(in_channels = 16, out_channels = 33, kernel_size = (3, 5, 2), stride = (2, 1, 1), padding = (4, 2, 0))
    val input1 = torch.randn(Seq(20, 16, 10, 50, 100))
    //    val input2 = torch.randn(Seq(16, 5, 7, 7, 7, 7))
...
class ConvTranspose1dSuite extends munit.FunSuite {
  test("ConvTranspose1d output shapes") {
    val m12 = nn.ConvTranspose1d(in_channels = 16, out_channels = 32, kernel_size = 3, stride = 2, padding = 1) // (5, 7), padding_mode = "reflect")
...
class ConvTranspose2dSuite extends munit.FunSuite {
  test("ConvTranspose2d output shapes") {
    val m12 = nn.ConvTranspose2d(in_channels = 16, out_channels = 33, kernel_size = 3, stride = 2) // (5, 7), padding_mode = "reflect")
...
class ConvTranspose2dSuite2 extends munit.FunSuite {
  test("ConvTranspose2d output shapes") {
    val m12 = nn.ConvTranspose2d(in_channels = 16, out_channels = 33, kernel_size = (3, 5), stride = (2, 1), padding = (4, 2)) // (5, 7), padding_mode = "reflect")
    val input = torch.randn(Seq(20, 16, 50, 100)) //, 64, 8, 9))
...
class ConvTranspose3dSuite extends munit.FunSuite {
  test("ConvTranspose3d output shapes") {
    val m12 = nn.ConvTranspose3d(in_channels = 16, out_channels = 33, kernel_size = (3, 5, 2), stride = (2, 1, 1), padding = (0, 4, 2)) // (5, 7), padding_mode = "reflect")
