...
import org.bytedeco.pytorch.Dropout2dImpl
...
final class Dropout2d[ParamType <: FloatNN | ComplexNN: Default](
  ...
  override private[torch] val nativeModule: Dropout2dImpl = Dropout2dImpl(options)
...
object Dropout2d:
  def apply[ParamType <: FloatNN | ComplexNN: Default](
      p: Float = 0.5,
      inplace: Boolean = false
  ): Dropout2d[ParamType] = new Dropout2d(p, inplace)
