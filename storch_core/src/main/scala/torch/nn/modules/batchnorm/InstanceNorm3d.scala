...
/** Applies Group Normalization over a mini-batch of inputs
  ...
  * @param affine
  *   track_running_stats a boolean value that when set to `true`, this module has learnable
  *   per-channel affine parameters initialized to ones (for weights) and zeros (for biases)
  */
