...
import org.bytedeco.pytorch.{ZeroPad3dImpl, ZeroPad3dOptions}
...
/** Applies a 2D adaptive average pooling over an input signal composed of several input planes.
  ...
  */
final class ZeroPad3d[ParamType <: FloatNN | ComplexNN: Default](
    val padding: Int | (Int) | (Int, Int, Int, Int, Int, Int)
  ...
  private val options: ZeroPad3dOptions = ZeroPad3dOptions(paddingNative)
  options.padding().put(paddingNative)

  override protected[torch] val nativeModule: ZeroPad3dImpl = ZeroPad3dImpl(
    options
  )
...
object ZeroPad3d:
  def apply[ParamType <: FloatNN | ComplexNN: Default](
      padding: Int | (Int) | (Int, Int, Int, Int, Int, Int)
  ): ZeroPad3d[ParamType] =
    new ZeroPad3d[ParamType](padding)
