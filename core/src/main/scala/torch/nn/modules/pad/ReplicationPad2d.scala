...
/** Applies a 2D adaptive average pooling over an input signal composed of several input planes.
  ...
  */
final class ReplicationPad2d[D <: BFloat16 | Float32 | Float64: Default](
  ...
  private val options: ReplicationPad2dOptions = ReplicationPad2dOptions(paddingNative)
  options.padding().put(paddingNative)

  override protected[torch] val nativeModule: ReplicationPad2dImpl = ReplicationPad2dImpl(
    options
  )
...
object ReplicationPad2d:
  def apply[D <: BFloat16 | Float32 | Float64: Default](
    ...
    new ReplicationPad2d[D](padding)
